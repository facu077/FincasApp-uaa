...
import ar.edu.um.fincaspp.uaa.config.audit.AuditEventConverter;
import ar.edu.um.fincaspp.uaa.domain.PersistentAuditEvent;
...
import static ar.edu.um.fincaspp.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
