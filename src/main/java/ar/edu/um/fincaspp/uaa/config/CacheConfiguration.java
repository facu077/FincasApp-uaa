package ar.edu.um.fincaspp.uaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("fincasAppUaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("fincasAppUaa");
        ...
        config.getMapConfigs().put("ar.edu.um.fincaspp.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
